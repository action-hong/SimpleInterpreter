...
class ProcedureDecl(AST):
    def __init__(self, proc_name, params, block_node):
        ...
        self.params = params  # a list of Param node
...
class ScopedSymbolTalbe(object):
...
class SemanticAnalyzer(NodeVisitor):
    ...
    def visit_Program(self, node):
        ...
        global_scope = ScopedSymbolTalbe(
          scope_name='global',
          scope_level=1,
        )
    ...
    def visit_ProcedureDecl(self, node):
        ...
        self.current_scope.insert(proc_name)

        print('ENTER scope: %s' %  proc_name)
        procedure_scope = ScopedSymbolTalbe(
